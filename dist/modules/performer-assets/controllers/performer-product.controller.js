...
], PerformerProductController.prototype, "uploadImage", null);
__decorate([
    common_1.Post('/'),
    common_1.HttpCode(common_1.HttpStatus.OK),
    auth_1.Roles('performer'),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object, payloads_1.ProductUpdatePayload,
        dtos_1.UserDto]),
    __metadata("design:returntype", Promise)
...
PerformerProductController = __decorate([
    common_1.Injectable(),
    common_1.Controller('performer/performer-assets/products'),
